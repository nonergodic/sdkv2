import { Platform } from "wormhole-base";
...
export interface TokenBridge<P extends Platform> {
  ...
  isTransferCompleted(vaa: VAA<"Transfer"> | VAA<"TransferWithPayload">): Promise<boolean>;
  //TODO bestEffortFindRedemptionTx()
  //signer required:
  createAttestation(address: UniversalOrNative<P>): AsyncGenerator<UnsignedTransaction>;
  submitAttestation(vaa: VAA<"AttestMeta">): AsyncGenerator<UnsignedTransaction>;
