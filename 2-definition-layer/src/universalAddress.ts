...
export class UniversalAddress implements Address {
  ...
  unwrap(): Uint8Array { return this.address; }
  toString() { return uint8ArrayToHexByteString(this.address); }
  toUint8Array() { return this.address; }
  toUniversalAddress() { return this; }
