 ...
 * context.startTransfer(...); // call any of the supported methods in a standardized uniform fashion
 */
export abstract class TokenBridgeAbstract<TransactionResult> {
   ...
   */
  abstract formatAddress(address: string): any;
  /**
   ...
   */
  abstract formatAssetAddress(address: string): Promise<any>;
  /**
   ...
   */
  abstract parseAssetAddress(address: any): Promise<string>;
